...
namespace GraphicsEditorByGawek
{
    ...
    {
        public FIP.FIP fip = new FIP.FIP();
        ...
        {
            pictureBox.Image = fip.ToGreyscale((Bitmap)pictureBox.Image);
        }

        private void skalaSzarościToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.ToGreyscaleAVG((Bitmap)pictureBox.Image);
        }

        private void skalaSzarościLightnessToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.ToGreyscaleLightness((Bitmap)pictureBox.Image);
        }

        private void czarnoBiałeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.ToBlackwhite((Bitmap)pictureBox.Image,150);
        }

        private void inversjaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.InverseImage((Bitmap)pictureBox.Image, 128);
        }

        private void negatywToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.NegativeImageColor((Bitmap)pictureBox.Image);
        }

        private void detekcjaKrawedziToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.ImagePrewittFilterColor((Bitmap)pictureBox.Image);
        }

        private void sepiaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.Sepia((Bitmap)pictureBox.Image, 50);
        }

        private void oilpaintingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.OilPaint((Bitmap)pictureBox.Image, 5, 255);
        }

        private void pixelizeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.SketchCharcoal((Bitmap)pictureBox.Image);
        }
        ...
        {
            pictureBox.Image = fip.HistoramEqualization((Bitmap)pictureBox.Image);
        }

        private void inneOpcjeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new AdjustWindow().Show();
        }

        private void ącyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = Smooth((Bitmap)pictureBox.Image);
            pictureBox.Refresh();
        ...
        {
            pictureBox.Image = fip.ImageMedianFilterGS((Bitmap)pictureBox.Image, 5);
            pictureBox.Refresh();
        }

        private void kuwaharaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pictureBox.Image = fip.ImageKuwaharaFilterColor((Bitmap)pictureBox.Image, 5);
            pictureBox.Refresh();
        ...
        {
            pictureBox.Image = fip.ImageErosionFilterGS((Bitmap)pictureBox.Image, 5);
            pictureBox.Refresh();
        }

        private void filtracjaKolorówToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new ColorFiltrationWindow().Show();
        }
    }
}
