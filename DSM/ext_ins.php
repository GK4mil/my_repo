...
<html lang="pl-PL">
   <head>
    ...
    <title>DSM - Nasłonecznienie</title> 
  ...
  <body>
  	...
  	<nav class="navbar  bg-dark navbar-dark">
		...
		<span class="navbar-text font-italic" id="dev-status" > Status urządzenia:
	  	...
	  	<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav font-italic">
				...
				<li class="nav-item">
					<a class="nav-link active" href="ext_ins.php">&#8226; Nasłonecznienie</a>
				</li>
				<hr>
				<li class="nav-item">
   	...
   	<div class="container">
   		...
   		<div class="row">
   			<div class="col-12">
   				<h3><strong>Nasłonecznienie</strong></h3>
   				<h5> w skali (0-10)</h5>
   		...
   		<div class="row">
	   		<div class="col-12">
		   		<form action="ext_ins.php" method="get">
