...
<html lang="pl-PL">
   <head>
    ...
    <title>DSM - Temperatura powietrza zewnętrzna</title> 
  ...
  <body>
  	...
  	<nav class="navbar  bg-dark navbar-dark">
		...
		<span class="navbar-text font-italic" id="dev-status" > Status urządzenia:
	  	...
	  	<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav font-italic">
				...
				<li class="nav-item">
					<a class="nav-link active" href="ext_temp.php">&#8226; Temperatura powietrza</a>
				</li>
				<li class="nav-item">
   	...
   	<div class="container">
   		...
   		<div class="row">
   			<div class="col-12">
   				<h3><strong>Temperatura powietrza zewętrzna</strong></h3>
   		...
   		<div class="row">
	   		<div class="col-12">
		   		<form action="ext_temp.php" method="get">
