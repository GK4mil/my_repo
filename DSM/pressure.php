...
<html lang="pl-PL">
   <head>
    ...
    <title>DSM - Ciśnienie atmosferyczne</title> 
  ...
  <body>
  	...
  	<nav class="navbar  bg-dark navbar-dark">
		...
		<span class="navbar-text font-italic" id="dev-status" > Status urządzenia:
	  	...
	  	<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav font-italic">
				...
				<li class="nav-item">
					<a class="nav-link active" href="pressure.php">&#8226; Ciśnienie atmosferyczne</a>
				</li>
				<li class="nav-item">
   	...
   	<div class="container">
   		...
   		<div class="row">
   			<div class="col-12">
   				<h3><strong>Ciśnienie atmosferyczne</strong></h3>
   		...
   		<div class="row">
	   		<div class="col-12">
		   		<form action="pressure.php" method="get">
